  ...
  return (
    <div className="rounded-2xl bg-[#111111] p-8">
      ...
      <p className="mb-6 text-sm text-zinc-500">
        Bress.io analizuje pozycje i CTR z Twoich danych GSC.
      </p>
      ...
      <div className="rounded-xl border border-white/10 bg-black/40 p-5">
        ...
        {!connected ? (
          ...
          >
            {connecting ? (
              <><Loader2 className="h-4 w-4 animate-spin" />Łączenie...</>
            ) : (
              <><span className="font-bold text-blue-600">G</span>Połącz konto Google</>
            )}
          </button>
        ) : (
